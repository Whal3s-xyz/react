...
const NoNftOwned = () => {
    return (
      <div role="status"
           className="whal3s-rounded-md whal3s-border whal3s-border-whal3s-gray whal3s-bg-white whal3s-px-4 whal3s-py-3 whal3s-shadow-sm">
          ...
          <div className="whal3s-relative whal3s-flex whal3s-items-start whal3s-space-x-3">
              ...
              <div className="whal3s-min-w-0 whal3s-flex-1">
                  <div className="whal3s-h-2.5 whal3s-bg-whal3s-gray whal3s-rounded-full dark:whal3s-bg-gray-700 whal3s-w-48 whal3s-mb-4"></div>
