...
const StepUninitialized = () => {
    return (
      <div className={`whal3s-h-full whal3s-grid whal3s-grid-cols-1 md:whal3s-grid-cols-2 md:whal3s-gap-5`}>
        ...
        <div
          className={`whal3s-bg-whal3s-gray whal3s-rounded-xl whal3s-aspect-[228/265] whal3s-w-full whal3s-order-1 md:whal3s-order-2 whal3s-flex whal3s-justify-center whal3s-items-center`}>
          <ImageSkeleton/>
        </div>
      </div>
